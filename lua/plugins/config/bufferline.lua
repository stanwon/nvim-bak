require('bufferline').setup {
  options = {
    ...
    --numbers = "none" or "ordinal" or "buffer_id" or "both" or function({ ordinal, id, lower, raise }): string,
    ...
    --offsets = {{filetype = "NvimTree", text = "File Explorer" or function , text_align = "left" or "center" or "right"}},
    ...
    sort_by = 'insert_after_current' or'insert_at_end' or 'id' or 'extension' or 'relative_directory' or 'directory' or 'tabs' or function(buffer_a, buffer_b)
      -- add custom logic
